...
- **Downgrading (Pro to Hobby)**: If a Pro user reverts to the Hobby tier and they currently have > 50 prompts, they retain all existing prompts. However, they are blocked from creating *new* prompts until they delete enough existing prompts to drop their total count below 50.
